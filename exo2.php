    ...
    <div class="container">
        ...
        <section class="exercice">
            ...
            <?php
                    ...
                    $newArray = [];
                    while (sizeof($newArray) !== 7) {
                    $newFruit = $fruits[array_rand($fruits)];
                    if (!in_array($newFruit, $newArray)) {
                        array_push($newArray, $newFruit);
                    };
                };
                    var_dump($newArray);
        ...
        <section class="exercice">
            ...
            <?php
                foreach($fruits as $fruit){
                    if (strlen(str_replace("ê", "e", $fruit)) <= 5){
                         echo '<li>'.$fruit.'</li>';
                    };
                };
